...
const SubmissionTextBox = (props: Props) => {
    ...
    const [snappables, _] = useSnappablePeople(props.cup.id, true);
        ...
        <>
            ...
            <div className="col-12 col-md col-lg-7">
                <form className="d-flex flex-column">
                    ...
                    <button
                        type="submit"
                        className={`rounded-3 mx-4 btn btn-primary snap-it-button colour-text-normal shadow-lg mt-2 fw-bold ${
